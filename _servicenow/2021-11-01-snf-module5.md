...
<p style="text-align: justify;">
    An <strong>Update Set</strong> is a group of customizations that can be moved from one instance of ServiceNow to another. Process records are captured, data not.
</p>
