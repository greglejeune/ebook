...
<p style="text-align: justify;">
    UI Policy and UI Policy Actions execute on the client side and only on form. Data Policies execute on the server side but can also run as UI Policy on the client side.
</p>
