...
<ul>
  ...
  <li>
    ...
    <ul>
      <li>Homepage</li>
      <li>
        List (Breadcrumb, Search, Wild card, Sort, Filter, Update, Activity, Personalize columns, Columns menu - [export - Excel, CSV, JSON, PDF] - Group by - Reporting, Contextual menu - View - Filter - Group By - Show - Favorite)
      </li>
