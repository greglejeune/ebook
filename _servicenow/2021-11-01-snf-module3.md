...
<p style="text-align: justify;">
    An <strong>Access Control</strong> is a security rule defined to restrit the permissions of a user from viewing and interacting whith data and may be set at the <strong>row-level</strong> and/or <strong>column-level</strong>.
</p>
