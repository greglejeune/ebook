...
<p style="text-align: justify;">
    An <strong>Import Set</strong> is a tool used to import data from various data sources and map (Transform Maps) that data into ServiceNow tables (Target Table). User with <strong>admin</strong> or <strong>import_admin</strong> role can manage all aspects of Import Sets.
</p>
